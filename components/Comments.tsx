...
const Comments = () => {
  ...
  return (
    <div className="border-t-2 border-gray-200 pt-4 px-10 bg-[#F8F8F8] border-b-2 lg:pb-0 pb-[100px]">
      <div className="overflow-scroll lg:h-[475px]">{comments.length ? <div>Videos</div> : <NoResults text="No comments yet!" />}</div>
      {userProfile && (
        <div className="absolute bottom-0 left-0 px-2 md:px-10">
